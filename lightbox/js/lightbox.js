;(function ( $ ) {
    ...
    $.lightbox.fn = {
        ...
        getData: function( element ) {
            ...
            $.lightbox.data.current.src = element.data('lightbox-src') ? element.data('lightbox-src') : element.attr('href');
            $.lightbox.data.group = {};
            ...
            $.lightbox.data.group.elements.map( function(index, element) {
                ...
                if ( $(element).data('lightbox-src') == $.lightbox.data.current.src || $(element).attr('href') == $.lightbox.data.current.src ) {
        ...
        changeImage: function ( direction ) {
            ...
            $.lightbox.data.current.src = $.lightbox.data.group.elements.eq($.lightbox.data.current.index).data('lightbox-src') ? $.lightbox.data.group.elements.eq($.lightbox.data.current.index).data('lightbox-src') : $.lightbox.data.group.elements.eq($.lightbox.data.current.index).attr('href');
        ...
        loadImg: function() {
            $.lightbox.dom.lightbox.container.window.frame.img.attr('src', $.lightbox.data.current.src );
        },
